...
print(f"RF training time: {rf_training_time} seconds")

#使用最佳参数重新训练随机森林分类器
best_rf = RandomForestClassifier(**best_params)
best_rf.fit(scaled_data, ALL_label)

# best_rf的路径，best_rf_2_特征数量_最佳准确率
best_rf_path = "model/best_rf_2_" + str(feature_num) + '_' + str(round(best_accuracy, 3)*100) + ".pkl"
